const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_SATIGRA] = sSatigraLevelUpLearnset,
    [SPECIES_GRADACIA] = sGradaciaLevelUpLearnset,
    [SPECIES_HERBAREM] = sHerbaremLevelUpLearnset,
    [SPECIES_MOBBURN] = sMobburnLevelUpLearnset,
    [SPECIES_CONFLEECE] = sConfleeceLevelUpLearnset,
    [SPECIES_ENLIGHDER] = sEnlighderLevelUpLearnset,
    [SPECIES_FOMPOUS] = sFompousLevelUpLearnset,
    [SPECIES_ASTROHAUT] = sAstrohautLevelUpLearnset,
    [SPECIES_WIRLIXPLOR] = sWirlixplorLevelUpLearnset,
    [SPECIES_BULBITE] = sBulbiteLevelUpLearnset,
    [SPECIES_LAMPUPA] = sLampupaLevelUpLearnset,
    [SPECIES_LUMINOTH] = sLuminothLevelUpLearnset,
    [SPECIES_SKELIPEDE] = sSkelipedeLevelUpLearnset,
    [SPECIES_COFFINSECT] = sCoffinsectLevelUpLearnset,
    [SPECIES_EUPHOLIDAE] = sEupholidaeLevelUpLearnset,
    [SPECIES_MLADIBUG] = sMladibugLevelUpLearnset,
    [SPECIES_SNAGOON] = sSnagoonLevelUpLearnset,
    [SPECIES_REPOCOON] = sRepocoonLevelUpLearnset,
    [SPECIES_NESNOOMI] = sNesnoomiLevelUpLearnset,
    [SPECIES_PUPONK] = sPuponkLevelUpLearnset,
    [SPECIES_SHIBONK] = sShibonkLevelUpLearnset,
    [SPECIES_INCOGNICROW] = sIncognicrowLevelUpLearnset,
    [SPECIES_SUSPECK] = sSuspeckLevelUpLearnset,
    [SPECIES_CYBIRB] = sCybirbLevelUpLearnset,
